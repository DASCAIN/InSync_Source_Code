...
urlpatterns = [
    ...
    path('api/tutor/chat-stream', views.api_tutor_chat_stream, name='api_tutor_chat_stream'),
    path('api/tutor/chat-cancel', views.api_tutor_chat_cancel, name='api_tutor_chat_cancel'),
    path('api/tutor/chat-sessions', views.api_get_chat_sessions, name='api_get_chat_sessions'),
    path('api/tutor/chat-sessions/<str:session_id>', views.api_delete_chat_session, name='api_delete_chat_session'),
    path('api/tutor/chat-history/<str:session_id>', views.api_get_chat_history, name='api_get_chat_history'),
